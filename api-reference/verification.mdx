...
- Every documented path and method in `api-reference/openapi.yaml` and split partials under `api-reference/openapi/` is derived from backend route declarations.
